...
#### 1.1 and、or、xor、nor
**and、or、xor、nor的指令格式：**
![image](E:\笔记\Verilog\logic_shift_nop\and_or_xor_nor.png)
...
#### 1.2 andi xori
**andi、xori的指令格式：**
![image](E:\笔记\Verilog\logic_shift_nop\andi_xori.png)
...
#### 1.3 lui
**lui的指令格式：**
![image](E:\笔记\Verilog\logic_shift_nop\lui.png)
...
![image](E:\笔记\Verilog\logic_shift_nop\sll_srl_sra_sllv_srlv_srav.png)
...
![image](E:\笔记\Verilog\logic_shift_nop\nop_ssnop_sync_pref.png)
...
**确定指令种类的过程：**
![image](E:\笔记\Verilog\logic_shift_nop\select.png)
**id.v:**
...
![image](E:\笔记\Verilog\logic_shift_nop\sumulate.png)